...
export default function TripulacionPage() {
  ...
  useEffect(() => {
    //Cuando esta vacio, solo se llama cuando se usa el componente
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <p className="absolute right-8 top-24 text-emerald-500"> Tengo {tripulantes.length} tripulantes</p>
